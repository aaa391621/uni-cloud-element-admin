<template>
	<div class="article-box">
		...
		<el-table :data="list" border @selection-change="handleSelectionChange" v-loading="loading">
			...
			<el-table-column prop="create_date" align="center" label="发布日期" width="200"></el-table-column>
		...
		<el-pagination background @current-change="handleCurrentChange" :current-page.sync="currentPage" :page-size="limit" layout="total,pager" :total="total"></el-pagination>
		<el-dialog :title="operateName" :visible.sync="articleFormVisible" :close-on-press-escape="false" :close-on-click-modal="false" width="60%" top="4vh">
			<el-form :model="article" ref="articleForm" :rules="rules" v-loading="uploading">
				<el-form-item label="标题" prop="title" label-width="50px"><el-input v-model="article.title"></el-input></el-form-item>
				...
				<el-form-item>
					<view class="editor">
						<view class="toolbar" @click="format">
							...
							<view
								:class="formats.backgroundColor === '#00ffff' ? 'ql-active' : ''"
